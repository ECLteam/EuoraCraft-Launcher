...
hiddenimports = [
    ...
    "ECL.Game.Core",
    "ECL.Game.Core.Libs",
    "ECL.Game.Core.GetGames",
    "ECL.Game.Core.Downloader",
    "ECL.Game.Core.FilesChecker",
    "ECL.Game.Core.NetLibs",
    "ECL.Game.Core.LoaderInstaller",
    "ECL.Game.Core.MicrosoftAuth",
    "ECL.Game.Core.YggdrasilAuth",
    "ECL.Game.Utils",
    "ECL.Game.Utils.Libs",
    "ECL.Game.Utils.SearchMinecraft",
    "ECL.Game.Utils.JavaScanner",
